...
// This file is a slightly modified copy of Go's src/pkg/net/fd_linux.go, see
// http://code.google.com/p/go/source/browse/src/pkg/net/fd_linux.go?name=0b8f3af00b0e
